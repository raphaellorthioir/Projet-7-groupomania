...
app.use('/uploads', express.static(path.join(__dirname, 'uploads'))); //  requêtes vers le dossier local  '/images' , on utilise static pour servir le dossier image, on définit la route avec path.join en indiquant le nom du dossier
